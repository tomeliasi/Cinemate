...
import { db, getUserDetails,removeUserFromLocalStorage,removeFavouritesFromLocalStorage } from "../../services/FirebaseService";
  ...
  return (
    <nav className="nav-container">
      ...
      <div className="nav-categories">
        ...
        {user ? ( <Link to="/Favourites" className="category">
